...
if client: logger.info("✅ Groq Llama 3.1 70B Client Loaded")

async def ask_groq(prompt):
    try:
        if not client: return "❌ ลืมใส่ GROQ_API_KEY ใน Railway Variables"
        ...
        return f"<b>⚡ Groq Llama 3.1 70B:</b>\n{res.content[0].message.content}"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = await ask_groq(update.message.text)
